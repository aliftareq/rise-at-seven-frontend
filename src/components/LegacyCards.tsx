...
//   return (
//     <section ref={sectionRef} className="relative h-[420vh] bg-[#efefed]">
//       <div className="sticky top-0 h-svh w-full overflow-hidden py-16">
//         <div className="absolute inset-x-20 top-16 bottom-16 flex items-center justify-center">
//           {cards.map((card, index) => (
//             <div
//               key={card.title}
//               className="legacy-card-wrap absolute flex h-full w-full items-center justify-center will-change-transform"
...
export default function LegacyCards() {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="relative hidden h-[420vh] bg-[#efefed] lg:block"
      >
        <div className="sticky top-0 h-svh w-full overflow-hidden py-16">

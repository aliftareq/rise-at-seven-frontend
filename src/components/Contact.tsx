...
//       if (delta > 0) {
//         targetSpeed.current = -0.035;
//       } else if (delta < 0) {
//         targetSpeed.current = 0.018;
//       }
...
//         mouse.current = { x: e.clientX, y: e.clientY };
//       }}
//       className="relative overflow-hidden bg-grey-100 py-20 text-[#111212] md:py-28 lg:py-36"
//     >
//       {/* Floating hover CTA */}
//       <a
//         ref={cursorRef}
...
//       <a href="/connect-with-us" className="block cursor-none">
...
//               <div
//                 key={`${item.text}-${index}`}
//                 className="flex shrink-0 items-center gap-x-4 px-2 pb-3 lg:gap-x-10 lg:px-5 lg:pb-10 lg:pt-5"
//               >
//                 <h2 className="relative inline-flex flex-1 text-left text-[75px] font-medium leading-[0.9] tracking-[-0.055em] text-[#111212] md:text-[100px] lg:pb-10 lg:text-[150px] xl:text-[210px]">
//                   {item.text}
//                 </h2>
...
export default function Contact() {
  ...
  useEffect(() => {
    const getSpeedConfig = () => {
      ...
      return {
        base: isMobile ? -0.025 : -0.02,
        scrollDown: isMobile ? -0.12 : -0.035,
        scrollUp: isMobile ? 0.06 : 0.025,
      };
    };
